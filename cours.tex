...
\begin{frame}
  ...
  \begin{center}  
  \begin{tabular}{l}
    min \textcolor{red}{$f(x) := (x_1 - 3)^2 + (x_2 - 4)^2$} tel que : \\
    \textcolor{blue}{$\left\{
    \begin{array}{l}
      g_1(x) := x_1 + x_2 - 5 \leq 0 \\
      g_2(x) := x_1 - x_2 - 2.5 \leq 0 \\
      g_3(x) := -x_1 \leq 0 \\
      g_4(x) := -x_2 \leq 0
    \end{array}
    \right.$}
...
\begin{frame}
  ...
  \begin{itemize}
    \item $S \supseteq X$ est un ensemble de vecteurs $x^T = (x_1,\dots,x_n)$% et la racine d'un arbre. 
...
\begin{frame}
  ...
  \only<2>{
    ...
    \item On peut noter les inconnues et contraintes $x^T = (x_1,x_2,x_3,x_4)$,
      ...
      (la valeur de la variable $x_i$ est la tâche affectée à l'ouvrier $i$).
      
    \item Pour exprimer la fonction objectif, on peut écrire $x_i := \sum_{j=1}^4 j d_{i,j}$.
      
    \item Le problème s'exprime donc ainsi
      \[
      \left\{
      \begin{array}{c}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item choix de la tâche à affecter en priorité : celle qui minimise $e$ %(valeur)
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \only<2>{
    ...
    \left(
    \begin{array}{cccc}
      \mbox{\sout{8}}         & \mbox{\sout{3}}  & \mbox{\sout{1}}  & \mbox{\sout{5}} \\
      \mbox{\sout{11}}        & 7         & \alert{1} & \alert{6} \\
      \mbox{\sout{7}}         & 8         & 6         & 8 \\
      \mbox{\sout{11}}        & \alert{6} & 4         & 9 
    \end{array}
    \right)
    \]
  }
  \only<3,6>{
    ...
    \begin{array}{cccc}
      \mbox{\sout{8}}& \mbox{\sout{3}} & \mbox{\sout{1}}  & \mbox{\sout{5}} \\
      11             & \mbox{\sout{7}} & \alert{1}        & \alert{6} \\
      \alert{7}      & \mbox{\sout{8}} & 6                & 8 \\
      11             & \mbox{\sout{6}} & 4                & 9 
    \end{array}
    \right)
    \]
  ...
  \only<4>{
    ...
    \begin{array}{cccc}
      \mbox{\sout{8}}& \mbox{\sout{3}} & \mbox{\sout{1}}  & \mbox{\sout{5}} \\
      11             & 7               & \mbox{\sout{1}}  & \alert{6} \\
      \alert{7}      & 8               & \mbox{\sout{6}}  & 8 \\
      11             & \alert{6}       & \mbox{\sout{4}}  & 9 
    \end{array}
    \right)
    \]
  }
  \only<5>{
    ...
    \begin{array}{cccc}
      \mbox{\sout{8}}& \mbox{\sout{3}} & \mbox{\sout{1}}  & \mbox{\sout{5}} \\
      11             & 7               & \alert{1}        & \mbox{\sout{6}} \\
      \alert{7}      & 8               & 6                & \mbox{\sout{8}} \\
      11             & \alert{6}       & 4                & \mbox{\sout{9}} 
    \end{array}
    \right)
    \]
  }
...
\begin{frame}
  ...
  \includegraphics[width=1\textwidth]{ex-bb}
